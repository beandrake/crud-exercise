# crud-exercise
A bare bones CRUD (create, read, update, delete) web application built using C#/ASP.NET Core with Visual Studio Community.
...
2. Generate unique passenger numbers
